...
"""
from ..mynewblock.WaterQueryCrossAttention import *
import math
import copy
import functools
...
class TransformerDecoder(nn.Module):
    ...
    def forward(self,
        ...
        for i, layer in enumerate(self.layers):
            ...
            output = layer(output, ref_points_input, value, spatial_shapes, attn_mask, query_pos_embed,water=water)
...
class DEIMTransformer(nn.Module):
    ...
    def forward(self, feats, targets=None,water=None):
